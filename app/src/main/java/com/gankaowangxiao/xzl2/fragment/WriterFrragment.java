...
import com.gankaowangxiao.xzl2.adapter.BottomAdapter;
...
public class WriterFrragment extends Fragment implements View.OnClickListener {
    ...
    private String showTitle = "批量关卡";

    public static WriterFrragment newInstance(String str) {
    ...
    public void changeUI(ArrayList<String> list) {
        if (list.size() > 0) {
            ...
            tvTitle.setText(showTitle + "(" + size + ")");
        } else {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        showTitle = arguments.getString("key");
    }
